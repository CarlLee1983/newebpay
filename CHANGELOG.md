...
- **程式碼重構**：全面採用 `PaymentType` Enum 取代硬編碼字串，提升程式碼一致性與維護性。
- **測試覆蓋**：補齊所有支付方式的單元測試，確保 100% 測試覆蓋率。
- **文件更新**：更新 `README.md` 支援支付方式列表，補上玉山 Wallet、台灣 Pay、BitoPay 等項目。

## [2.2.1] - 2025-12-05

### 優化

- **品質工具**：將 PHPStan 分析等級提升至 Level 6。
